...
inputpass.addEventListener('input', (e) => {
  ...
  if(x < 8) {
    ...
    for (var v = 0; v <= passstrenghttext.symbols.length; v++) {
      var tepnum = passstrenghttext.symbols
      if(symbol === tepnum[v]) {
  ...
  function capalpha(capalpha) {
    for (var v = 0; v <= passstrenghttext.capalphabet.length; v++){
      var tepnum = passstrenghttext.capalphabet
  ...
  if (checksymbol !== null && checknum !== null && checkcalalpha !== null) {
    bar.setAttribute('style', `width: 100%; background-color: rgb(76, 233, 9);`,)
    passstrenghttext.innerHTML = 'Password Strength : &#128525;'
  }

  else if (checksymbol === null && checknum !== null && checkcalalpha !== null) {
